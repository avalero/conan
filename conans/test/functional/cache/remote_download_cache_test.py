...
class DownloadCacheTest(unittest.TestCase):
    ...
    def test_download_skip(self):
        ...
        client.run(
            'config set storage.remote_cache_url="http://localhost:8081/artifactory/generic-local/"')
        ...
        print(content.count('"_action": "DOWNLOAD"'))
...
#     def setUp(self):
#         cache_folder = temp_folder()
#         remote_cache_url = "http://www.localhost.es:8081/artifactory/generic-local/"
